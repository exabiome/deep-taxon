...
def get_conf_args():
    return {
        ...
        'n_outputs': dict(help='the number of outputs in the final layer. Ignored if --classify without arcface loss', default=512),
        ...
        'arcface': dict(action='store_true', help='use arcface loss function', default=False),
...
def process_args(args=None):
    ...
    if args.classify and not args.arcface:
